...
const Header = () => {
    ...
    return (
        <header className="top-0 left-0 sm:px-12 px-6 z-20 fixed w-full bg-[#1105183e] backdrop-filter backdrop-blur-lg p-4">
            <section className="container flex gap-8 lg:gap-12 item-center justify-between">
                ...
                <div className={`${mobileMenuOpen ? 'block' : 'hidden'} lg:hidden p-6 bg-absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
