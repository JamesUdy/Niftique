...
const HeroSection = () => {
  return (
    <section className='container mx-auto max-w-full space-y-16 lg:space-y-0 lg:mt-12 lg:mb-24 px-2 lg:px-10 sm:px-6 justify-between flex flex-col lg:flex-row'>
            <div className='flex flex-col justify-center lg:w-1/2 space-y-4 m-2'>
